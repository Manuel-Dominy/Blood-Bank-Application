...
import 'package:reddot/screens_admin/sign_up.dart';
import 'package:reddot/widget/customblood.dart';
import 'package:http/http.dart' as http;

class UserBlood extends StatefulWidget {
  const UserBlood({super.key, required this.text, required this.phono});
  final String text;
  final String phono;

  @override
  State<UserBlood> createState() => _UserBloodState();
}

class _UserBloodState extends State<UserBlood> {
  List listresponse = [];
  var blood = 'A+';
  var pic;
  var name;
  ...
  Future<void> api(text, blood) async {
    ...
    response = await http.post(
        Uri.parse('http://192.168.234.10/project/query2.php'),
